  ...
  return (
    ...
    >
      ...
      <img
        ...
        loading="lazy"
        onError={(e) => {
          (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400&h=600&fit=crop';
        }}
      />
...
export function BookCardSkeleton() {
  return (
    <div className="book-card skeleton" style={{ aspectRatio: '3/4' }}>
      <div style={{ padding: 'var(--space-6)', position: 'absolute', bottom: 0, left: 0, right: 0 }}>
        <div className="skeleton" style={{ height: '1rem', width: '30%', marginBottom: 'var(--space-2)' }} />
        <div className="skeleton" style={{ height: '1.5rem', width: '80%', marginBottom: 'var(--space-2)' }} />
