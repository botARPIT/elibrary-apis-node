 ...
 */
export const PUBLIC_ROUTES = [ROUTES.HOME, ROUTES.LOGIN, ROUTES.REGISTER, ROUTES.BROWSE] as const;

/**
 * Protected routes (authentication required)
 */
export const PROTECTED_ROUTES = [ROUTES.MY_BOOKS, ROUTES.UPLOAD] as const;
 ...
 */
export function isBookGenre(
  value: unknown
): value is (typeof BOOK_GENRES)[keyof typeof BOOK_GENRES] {
  return (
    typeof value === 'string' && (Object.values(BOOK_GENRES) as readonly string[]).includes(value)
  );
}
...
export function isTheme(value: unknown): value is (typeof THEMES)[keyof typeof THEMES] {
  return typeof value === 'string' && (Object.values(THEMES) as readonly string[]).includes(value);
}
