...
export function BookDetailPage() {
     ...
     */
    const isAuthor = isAuthenticated && book && (
        typeof book.author === 'object' 
            ? book.author._id === userId 
            : book.author === userId
    );

    const authorName = book && typeof book.author === 'object' 
        ? book.author.name 
        : 'Unknown Author';
        ...
        return (
            <main className="container section" aria-busy="true" aria-label="Loading book details">
                <div className="book-detail">
                    ...
                    <div>
                        <div className="skeleton" style={{ height: '1.5rem', width: '100px', marginBottom: 'var(--space-4)' }} />
                        <div className="skeleton" style={{ height: '3rem', width: '80%', marginBottom: 'var(--space-4)' }} />
                        <div className="skeleton" style={{ height: '1.5rem', width: '200px', marginBottom: 'var(--space-6)' }} />
    ...
    return (
        <main className="container section">
            ...
            <article className="book-detail" itemScope itemType="https://schema.org/Book">
                ...
                >
                    <span className="badge badge-primary book-detail-genre" itemProp="genre">{book.genre}</span>
                    
                    <h1 className="book-detail-title" itemProp="name">{book.title}</h1>
                    
                    <div className="book-detail-author" itemProp="author" itemScope itemType="https://schema.org/Person">
                        <div className="book-detail-author-avatar" aria-hidden="true">{authorInitial}</div>
                        <span>by <span itemProp="name">{authorName}</span></span>
                    </div>

                    <div className="book-detail-meta">
                        <div className="book-detail-meta-item">
                            <span className="book-detail-meta-label">
                                <Calendar size={14} style={{ display: 'inline', marginRight: '4px' }} aria-hidden="true" />
                                Published
                            </span>
                    ...
                    <div className="book-detail-actions">
                        <motion.a
                            href={isValidUrl(book.file) ? book.file : '#'}
                            target="_blank"
