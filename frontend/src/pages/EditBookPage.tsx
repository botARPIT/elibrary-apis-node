...
export function EditBookPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (bookFile) form.append('file', bookFile);
        ...
        if (isValidImageUrl(url) || url.startsWith('http')) {
            return (
                <a 
                    ...
                    style={{ color: 'var(--color-primary-400)', display: 'inline-flex', alignItems: 'center', gap: '4px' }}
                >
                    {label}
        ...
        return (
            <main className="container section" aria-busy="true" aria-label="Loading book editor">
                <div style={{ maxWidth: '700px', margin: '0 auto' }}>
                    <div className="skeleton" style={{ height: '3rem', width: '150px', marginBottom: 'var(--space-8)' }} />
                    <div className="card">
                        <div className="card-body">
                            <div className="skeleton" style={{ height: '2rem', width: '200px', marginBottom: 'var(--space-6)' }} />
                            <div className="skeleton" style={{ height: '3rem', width: '100%', marginBottom: 'var(--space-4)' }} />
                            <div className="skeleton" style={{ height: '3rem', width: '100%', marginBottom: 'var(--space-4)' }} />
                            <div className="skeleton" style={{ height: '8rem', width: '100%', marginBottom: 'var(--space-4)' }} />
    ...
    return (
        <main className="container section" role="main" aria-label="Edit book">
            ...
            >
                <Link to={`/books/${bookId}`} className="btn btn-ghost" aria-label="Go back to book details">
